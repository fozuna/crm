...
final class ProposalBrandingRepository
{
    public function get(): array
    {
        ...
        return [
            ...
            'logo_light_path' => (string) ($company['logo_light_path'] ?? ''),
            'logo_light_mime' => (string) ($company['logo_light_mime'] ?? ''),
            'logo_dark_path' => (string) ($company['logo_dark_path'] ?? ''),
            'logo_dark_mime' => (string) ($company['logo_dark_mime'] ?? ''),
